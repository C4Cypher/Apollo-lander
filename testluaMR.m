...
main(!IO) :-
	LS0 = lua_state(L1@lua_new, null_id, empty_trail),
	impure lua_pushinteger(L1, 1),
	not (
		semipure set(2, LS0, LS1),
		fail
	),
		semipure set(4, LS0, LS1),
	
	semipure I = lua_tointeger(LS1^lua, index(1)),
	print(I, !IO).	
